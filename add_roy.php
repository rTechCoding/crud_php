        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                            ...
                            <b>
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="class" class="form-control" id="formGroupExampleInput" placeholder="class" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="exampleInputLastname" class="form-label">section</label>
                                        <input type="text" name="section" class="form-control" id="formGroupExampleInput" placeholder="section">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="roll" class="form-control" id="formGroupExampleInput" placeholder="roll number">
                                    </div>
                    ...
                    <div>
                                <a href="add_roy.php" role="button" class="btn btn-outline-dark" style="float: right;margin-top:-42px;"><i class="fa fa-chevron-circle-left"></i>Add</a>
                                </div>
